...
export default function Page() {
	return (
		<main className='min-h-screen p-5 pt-0'>
			...
			<h2 className='text-center text-xl font-light mt-1 italic'>
				Open Minds. Open Source. Crafting Utopian Futures.
			</h2>
			<h3 className='max-w-[400px] text-center text-lg font-light mt-3 mx-auto'>
				PlatoPunk is a platform for people who are passionate about
				sharing/using/building (open-source) tech/art that crafts a
				better future.
			</h3>
			...
			<div className='pt-20'>
				...
				<div className='mt-8 text-center'>
					<h3 className='text-xl mb-3 underline underline-offset-4'>
						Manifesto
					</h3>
					<ul className='text-lg font-light'>
						...
						<li className='py-1'>
							<a
								...
								href='https://github.com/KhoiUna/platopunk'
								target='_blank'
							>
								Open source
							</a>
